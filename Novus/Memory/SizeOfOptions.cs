...
public enum SizeOfOptions
{
	...
	/// </remarks>
	/// <returns>The native size if the type has a native representation; <see cref="Win32.Native.ERROR_SV" /> otherwise</returns>
	Native,
	...
	/// </remarks>
	/// <returns>
	///     Managed size if the type has an <see cref="EEClassLayoutInfo" />; <see cref="Win32.Native.ERROR_SV" />
	///     otherwise
	/// </returns>
	Managed,
