...
/// </summary>
public readonly struct PackedFieldsReader
{
	...
	public PackedFieldsReader(Pointer<DWORD> p, int l)
	{
		m_ptr                  = p;
	...
	/// </summary>
	public Pointer<DWORD> PackedFields => m_ptr;

	/// <summary>
	/// The fields in their unpacked state
	/// </summary>
	public Pointer<DWORD> UnpackedFields => m_ptr;

	/// <summary>
	///     Get the value of the given field when the structure is in its unpacked state.
	/// </summary>
	public DWORD GetUnpackedField(DWORD dwFieldIndex)
		=> UnpackedFields[(int) dwFieldIndex];

	public DWORD GetPackedField(DWORD dwFieldIndex)
	{
		DWORD dwOffset = 0;
	...
	public DWORD BitVectorGet(DWORD dwOffset, DWORD dwLength)
	{
